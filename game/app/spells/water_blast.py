...
class WaterBlastSpellSpawner(TargetSpellSpawner):
    def __init__(self, *groups, scale=1, timeout=200, damage=10):
    ...
    def _get_animator(self):
        ...
        animation_attack = Animation(self._image_attack, (0, 0), (self.__w, self.__h), delay=5, loop=False, auto_row=True)
